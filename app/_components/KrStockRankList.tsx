...
import StockRankCard from "./KrStockRankCard";
import axios from "axios";

const KrStockRankList = (props: any) => {
    ...
    <div className="flex flex-col items-center w-full max-w-5xl">
      <div className="w-full divide-y">
        {data.slice(0, 10 * ShowMore).map((d: any, idx: any) => (
          <StockRankCard key={d.id} data={d} rank={idx + 1} islogo={d.islogo} />
        ))}
      </div>
      <div
...
export default KrStockRankList;
